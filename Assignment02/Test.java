...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("");
        //If you do not create a class constructor, Java creates one for you
        Student s1 = new Student();
        //Calculating sub total, total, and grade
        s1.calculateMarks(test1, test2, as1, as2, as3, finalExam);
        //Printing the marks
        System.out.println(s1.getMarkInfo());
    }
